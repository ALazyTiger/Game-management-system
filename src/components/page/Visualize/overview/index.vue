  ...
  <div class="content">
    ...
    <div class="container">
      ...
      <el-table :data="dataList" border class="table" ref="multipleTable">
        <el-table-column prop="name" label="累计设备新增"></el-table-column>
        <el-table-column prop="num" label="累计账号新增" ></el-table-column>
        <el-table-column prop="road" label="转化率%"></el-table-column>
        <el-table-column prop="date" label="累计付费人数" sortable ></el-table-column>
        <el-table-column prop="date" label="付费率%" sortable ></el-table-column>
        <el-table-column prop="date" label="累计付费金额" sortable ></el-table-column>
        <el-table-column prop="date" label="Arpu" sortable ></el-table-column>
        <el-table-column prop="date" label="Arppu" sortable ></el-table-column>
      </el-table>
    </div>
  </div>
</template>
