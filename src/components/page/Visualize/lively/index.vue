<template>
  <div class="content">
    <div class="crumbs">活跃数据</div>
    <div class="container">
      <div class="rolequery-box">
        <div class="demo-input-suffix">
          渠道筛选：
          <el-radio-group v-model="canalList" @change="canalChange">
            <el-radio v-for="item in canalOptions" :key="item" :label="item" :value="item"></el-radio>
          </el-radio-group> 
        </div>
      </div>
      <div class="rolequery-box">
      ...
      <el-table :data="dataList" border class="table" ref="multipleTable">
        ...
        <el-table-column prop="num" label="日活跃" ></el-table-column>
        <el-table-column prop="road" label="周活跃"></el-table-column>
        <el-table-column prop="date" label="周活跃比% （日活跃/周活跃）"  ></el-table-column>
        <el-table-column prop="date" label="月活跃"  ></el-table-column>
        <el-table-column prop="date" label="月活跃比% （日活跃/周活跃）"  ></el-table-column>
      </el-table>
    </div>
  </div>
</template>
