  ...
  <div class="content">
    ...
    <div class="container">
      ...
      <el-table :data="dataList" border class="table" ref="multipleTable">
        ...
        <el-table-column prop="num" label="新增付费人数" ></el-table-column>
        <el-table-column prop="num" label="新增付费金额" ></el-table-column>
        <el-table-column prop="num" label="2-3日付费人数" ></el-table-column>
        <el-table-column prop="num" label="2-3日付费金额" ></el-table-column>
        <el-table-column prop="num" label="4-7日付费人数" ></el-table-column>
        <el-table-column prop="num" label="4-7日付费金额" ></el-table-column>
        <el-table-column prop="num" label="8-14日付费人数" ></el-table-column>
        <el-table-column prop="num" label="8-14日付费金额" ></el-table-column>
        <el-table-column prop="num" label="15-30日付费人数" ></el-table-column>
        <el-table-column prop="num" label="15-30日付费金额" ></el-table-column>
        <el-table-column prop="num" label="30日以上付费人数" ></el-table-column>
        <el-table-column prop="num" label="30日以上付费金额" ></el-table-column>
      </el-table>
    </div>
  </div>
</template>
