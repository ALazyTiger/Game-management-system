  ...
  <div class="content">
    ...
    <div class="container">
      ...
      <el-table :data="dataList" border class="table" ref="multipleTable">
        <el-table-column prop="name" label="时段（0：00-23：59）" sortable width="280"></el-table-column>
        <el-table-column prop="num" label="活跃数" ></el-table-column>
      </el-table>
    </div>
  </div>
</template>
