  ...
  <div class="content">
    ...
    <div class="container">
      ...
      <el-table :data="dataList" border class="table" ref="multipleTable">
        <el-table-column prop="name" label="日期" sortable width="280"></el-table-column>
        <el-table-column prop="num" label="流失人数" ></el-table-column>
        <el-table-column prop="num" label="流失比例%(每日的流失人数占当日前7日活跃用户的比例)" ></el-table-column>
      </el-table>
    </div>
  </div>
</template>
