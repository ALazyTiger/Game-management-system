  ...
  <div class="content">
    ...
    <div class="container">
      ...
      <el-table :data="dataList" border class="table" ref="multipleTable">
        ...
        <el-table-column prop="num" label="账号新增" ></el-table-column>
        <el-table-column prop="num" label="Ltv3" ></el-table-column>
        <el-table-column prop="num" label="Ltv7" ></el-table-column>
        <el-table-column prop="num" label="Ltv15" ></el-table-column>
        <el-table-column prop="num" label="Ltv30" ></el-table-column>
        <el-table-column prop="num" label="Ltv45" ></el-table-column>
        <el-table-column prop="num" label="Ltv60" ></el-table-column>
      </el-table>
    </div>
  </div>
</template>
