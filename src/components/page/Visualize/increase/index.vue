  ...
  <div class="content">
    ...
    <div class="container">
      ...
      <el-table :data="dataList" border class="table" ref="multipleTable">
        ...
        <el-table-column prop="num" label="绝对账号新增" ></el-table-column>
        <el-table-column prop="road" label="滚服账号新增"></el-table-column>
        <el-table-column prop="date" label="绝对新增付费金额" sortable ></el-table-column>
        <el-table-column prop="date" label="滚服新增付费金额" sortable ></el-table-column>
        <el-table-column prop="date" label="次日留存%" sortable ></el-table-column>
        <el-table-column prop="date" label="三日留存%" sortable ></el-table-column>
        <el-table-column prop="date" label="七日留存%" sortable ></el-table-column>
        <el-table-column prop="date" label="十五日留存%" sortable ></el-table-column>
        <el-table-column prop="date" label="月留存%" sortable ></el-table-column>
      </el-table>
    </div>
  </div>
</template>
