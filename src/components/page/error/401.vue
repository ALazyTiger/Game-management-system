<template>
  <div style="background:#fff;margin-top: -20px;height:100%;">
    <div class="wscn-http401">
      ...
      <div class="bullshit">
        ...
        <el-button type="primary" plain @click="returnPage">返回首页</el-button>
      </div>
       <div class="pic-401">
        <img class="pic-401__parent" src="../../../../static/images/401_images/401.gif" alt="401">
      </div>
    </div>
  </div>
</template>
