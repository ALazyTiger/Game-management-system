<template>
  <div class="content">
    ...
    <div class="container">
      ...
      <el-table :data="Crystal" border class="table" ref="multipleTable">
        <el-table-column prop="name" label="玩家昵称"></el-table-column>
        <el-table-column prop="num" label="水晶变更数量" ></el-table-column>
