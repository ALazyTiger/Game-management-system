<template>
  <div class="content">
    <div class="crumbs">发布跑马灯<div class="tips"><span></span></div></div>
    <div class="container">
        ...
        <el-form ref="form" :model="form" label-width="130px">
          ...
          <el-form-item label="跑马灯内容：">
           ...
           <el-form-item label="跑马灯展示：">
             <span class="d-i-b mr10"><el-input  v-model="form.frequency" class="role-input " placeholder="输入次数"></el-input></span>
             <span class="d-i-b">/</span>
             <span class="d-i-b ml10"><el-input  v-model="form.horseTime" class="role-input " placeholder="输入时间"></el-input></span>
            
            
          </el-form-item>
          <el-form-item label="跑马灯展示时间：">
            <el-date-picker v-model="form.horseTimeRange" type="datetimerange" range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期"></el-date-picker>
          </el-form-item>
          <el-form-item>
